export class ReadingModeManager {
  ...
  applyReadingMode() {
    ...
    if (this.slideViewer.isReadingMode) {
      ...
      // Hide slide overview buttons in reading mode.
      if (this.slideViewer.thumbnailManager.showThumbnailsBtn) this.slideViewer.thumbnailManager.showThumbnailsBtn.style.display = 'none';
      if (this.slideViewer.thumbnailManager.showThumbnailsBtnMobile) this.slideViewer.thumbnailManager.showThumbnailsBtnMobile.style.display = 'none';
      ...
      // Show slide overview buttons in slide mode.
      if (this.slideViewer.thumbnailManager.showThumbnailsBtn) this.slideViewer.thumbnailManager.showThumbnailsBtn.style.display = '';
      if (this.slideViewer.thumbnailManager.showThumbnailsBtnMobile) this.slideViewer.thumbnailManager.showThumbnailsBtnMobile.style.display = '';
