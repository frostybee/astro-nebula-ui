...
1. `astro-galaxy-components` is a Starlight [plugin](https://starlight.astro.build/reference/plugins/). Install it by running the following command in your terminal:
   ...
   ```sh
   npm install astro-galaxy-components
   ```
   ...
   ```sh
   pnpm add astro-galaxy-components
   ```
   ...
   ```sh
   yarn add astro-galaxy-components
   ```
