...
| `href` | `string` | `#${title.toLowerCase()}` | Optional link for the card's badge |
...
<BentoGrid columns={4} gap="1.5rem">
...
```astro
<BentoGrid columns={4} gap="1.5rem">
  <BentoCard title="Large Card" span={{ rows: 2, cols: 2 }}>
    <h2>Featured Content</h2>
    <p>This card spans 2 rows and 2 columns</p>
  </BentoCard>
  
  <BentoCard title="Wide Card" span={{ cols: 2 }}>
    <p>This card spans 2 columns</p>
  </BentoCard>
  
  <BentoCard title="Tall Card" span={{ rows: 2 }}>
